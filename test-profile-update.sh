...
show_manual_test_instructions() {
    ...
    echo "   docker logs obp-keycloak --follow | grep -E \"🟡|🔄|forcePersist\""
    echo ""
    ...
    echo "✅ Logs should show attribute updates (🟡 messages)"
    echo "✅ Logs should show force persistence (🔄 messages)"
    echo "✅ Database should reflect the new values"
    echo "✅ updatedat timestamp should change"
}
